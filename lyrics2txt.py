...
class Lyrics2pptx:
    ...
    def create_pptx(self):
        ...
        while song_idx < (len(self.song_lyrics)):
            print('out\\'+self.song_fn[song_idx].split('.pptx')[0] + '.txt')
            txtfile = open('out\\'+self.song_fn[song_idx].split('.pptx')[0] + '.txt',"w")
            i=0
            ...
            while i < (len(self.song_lyrics[song_idx])):
                ...
                if i == 0:
                    ...
                    # print(self.song_lyrics[song_idx][i])
                    # print()
                    txtfile.write(self.song_lyrics[song_idx][i]+'\n\n')
